...
describe('BackButton', () => {
  ...
  it('applies custom id when provided', () => {
    renderWithRouter(<BackButton {...defaultProps} id="custom-back-button" />);
  ...
  it('renders with different route paths', () => {
    const { rerender } = renderWithRouter(<BackButton to="/home" children="Back to Home" />);
  ...
  it('renders with different children content', () => {
    const { rerender } = renderWithRouter(<BackButton to="/test" children="← Go Back" />);
  ...
  it('handles complex children content', () => {
    ...
    renderWithRouter(<BackButton to="/list" children={complexChildren} />);
