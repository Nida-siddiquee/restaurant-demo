...
describe('PostcodeSelectPage', () => {
  ...
  it('dispatches fetchPostcodesRequest on mount', () => {
    ...
    expect(dispatch).toHaveBeenCalledWith(
      expect.objectContaining({ type: 'postcodes/fetchPostcodesRequest' }),
    );
  });
  ...
  it('dispatches selectPostcode and fetchRestaurantsRequest and navigates when "View Restaurants" is clicked', () => {
    ...
    expect(dispatch).toHaveBeenCalledWith(
      expect.objectContaining({ type: 'postcodes/selectPostcode' }),
    );
    expect(dispatch).toHaveBeenCalledWith(
      expect.objectContaining({ type: 'restaurants/fetchRestaurantsRequest' }),
    );
